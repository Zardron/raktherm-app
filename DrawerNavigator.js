...
import { Image, Box, AspectRatio, Center } from "native-base";
        ...
        >
          <TouchableOpacity>
            ...
            >
              ...
              >
                <FontAwesome5 name="home" size={24} color="#008053" />
              </View>
              <View style={{ flex: 0.8 }}>
                <Text
                  style={{
          ...
          <TouchableOpacity>
            ...
            >
              ...
              >
                <MaterialIcons name="video-library" size={24} color="#404041" />
              </View>
              <View style={{ flex: 0.8 }}>
                <Text
                  style={{
        ...
        >
          ...
          <TouchableOpacity>
            ...
            >
              ...
              >
                <Ionicons name="ios-settings-sharp" size={24} color="#404041" />
              </View>
              <View style={{ flex: 0.8 }}>
                <Text
                  style={{
